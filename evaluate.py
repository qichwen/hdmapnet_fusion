...
def eval_iou(model, val_loader):
    ...
    total_union = 0
    with torch.no_grad():
        for imgs, trans, rots, intrins, post_trans, post_rots, lidar_data, lidar_mask, car_trans, yaw_pitch_roll, semantic_gt, instance_gt, direction_gt, sample_token in tqdm.tqdm(val_loader):
            ...
            if torch.cuda.is_available():
                ...
                semantic, embedding, direction = model(imgs, trans, rots, intrins,
                                                    ...
                                                    lidar_mask, car_trans, yaw_pitch_roll, sample_token)
